                            ...
                            <form action="{{ route('guest.store') }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="insiden" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="unit_penyebab_insiden" class="form-control" required>
                                            <option value="">Pilih Unit Penyebab Insiden</option>
                                            @foreach($unitPenyebab as $up)
